...
//
    ...
    public Client(String host, Integer port) {
        ...
        this.name = "user" + Integer.toString(genId());
    }

    public int genId(){
        Random rn = new Random();
        return rn.nextInt()*rn.nextInt()%100;
    }
    ...
    public List<String> getMessages() {
        ...
        try {
            ...
            for (Object o : jsonArray) {
                ...
                System.out.println( ((HashMap)o).get("user") + " : \"" + ((HashMap)o).get("text") + "\"");
    ...
    public void run() {
        ...
        while (true) {
            ...
            Message message = new Message(name,genId(),text);
            sendMessage(message);
        }
    }
}
